...
action = IntVar()
btnusr = Button(root, text ="USUARIOS", command=lambda: actions(1), height=1, width=12)
btnusr.grid(column=1, row=1, padx=4, pady=5)

btnhab = Button(root, text ="HABITACIONES", command=lambda: actions(1), height=1, width=12)
btnhab.grid(column=1, row=2, padx=4, pady=5)

btndisp = Button(root, text ="DISPOSITIVOS", command=lambda: actions(1), height=1, width=12)
btndisp.grid(column=3, row=1, padx=4, pady=5)

btncrd = Button(root, text ="CERRADURAS", command=lambda: actions(2), height=1, width=12)
btncrd.grid(column=3, row=2, padx=4, pady=5)

btnext = Button(root, text ="SALIR", command=lambda: actions(1), height=1, width=12)
